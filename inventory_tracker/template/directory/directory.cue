...
userList: [...directoryv1.#User] & [
		...
		username:    "inventory_tracker_admin"
		displayName: "admin"
		secret:      {{ generateApplicationUUID "inventory_tracker_admin" | quote }}
	...
	},
	{
		...
		username:    "inventory_tracker_staff"
		displayName: "staff"
		secret:      {{ generateApplicationUUID "inventory_tracker_staff" | quote }}
		userProfile: directoryv1.#UserProfile & {
			userTypeId: userTypeMap.Permanent.id
		}
	...
	},
	{
		...
		username:    "inventory_tracker_manager"
		displayName: "manager"
		secret:      {{ generateApplicationUUID "inventory_tracker_manager" | quote }}
		userProfile: directoryv1.#UserProfile & {
			userTypeId: userTypeMap.Permanent.id
		}
