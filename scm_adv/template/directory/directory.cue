...
userList: [...directoryv1.#User] & [
		...
		displayName: "admin"
		secret:      {{ generateApplicationUUID "scm_adv_admin" | quote }}
	...
	},
	{
		...
		displayName: "staff"
		secret:      {{ generateApplicationUUID "scm_adv_staff" | quote }}
		userProfile: directoryv1.#UserProfile & {
			userTypeId: userTypeMap.Permanent.id
		}
	...
	},
	{
		...
		displayName: "manager"
		secret:      {{ generateApplicationUUID "scm_adv_manager" | quote }}
		userProfile: directoryv1.#UserProfile & {
			userTypeId: userTypeMap.Permanent.id
		}
