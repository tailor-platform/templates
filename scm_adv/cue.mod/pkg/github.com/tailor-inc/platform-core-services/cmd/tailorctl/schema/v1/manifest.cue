...
import (
	...
	"github.com/tailor-inc/platform-core-services/api/gen/go/connector/v1:connectorv1"
)
...
#Connector: {
	manifests: [...connectorv1.#Manifest]
}

#TailorManifest: {
	version: "v1"
	kind:    #KindTailorDB | #KindGateway | #KindPipeline | #KindStateFlow | #KindDirectory | #KindRuleEngineRule | #KindRuleEngineFunction | #KindAuthentication | #KindDirectorySeed | #KindGraphqlSeed | #kindConnector
	spec:    [
