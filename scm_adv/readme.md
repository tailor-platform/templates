...
As for the `$admin_password`, please check your `./charts/directory/directory.cue` file and see `secret` of `username:    "scm_adv_admin"` in the `userList`.
```bash
...
tailorctl app login -u 'scm_adv_admin' -p '$admin_password'
