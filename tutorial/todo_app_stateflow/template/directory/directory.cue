...
userList: [...directoryv1.#User] & [
		...
		displayName: "admin"
		secret:      {{ generateApplicationUUID "todo_app_stateflow_admin" | quote }}
	...
	},
	{
		...
		displayName: "staff"
		secret:      {{ generateApplicationUUID "todo_app_stateflow_staff" | quote }}
	...
	},
	{
		...
		displayName: "manager"
		secret:      {{ generateApplicationUUID "todo_app_stateflow_manager" | quote }}
