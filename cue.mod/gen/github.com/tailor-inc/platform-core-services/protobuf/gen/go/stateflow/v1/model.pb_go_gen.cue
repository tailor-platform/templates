...
#Namespace: {
	...
	admins?: [...string] @go(Admins,[]string) @protobuf(3,bytes,rep,proto3)
	viewers?: [...string] @go(Viewers,[]string) @protobuf(4,bytes,rep,proto3)
}
...
#StateFlowCreated: {
	stateFlowId?: string @go(StateFlowId) @protobuf(1,bytes,opt,name=state_flow_id,json=stateFlowId,proto3)
}

#StateCreated: {
	stateId?: string @go(StateId) @protobuf(1,bytes,opt,name=state_id,json=stateId,proto3)
}
...
#StateTransition: {
	...
	prevState?:  string @go(PrevState) @protobuf(3,bytes,opt,name=prev_state,json=prevState,proto3)
	state?:      string @go(State) @protobuf(4,bytes,opt,proto3)
}
